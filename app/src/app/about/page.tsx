      ...
      <section className="py-16 sm:py-24 px-4 sm:px-6 bg-zinc-950">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <FadeIn delay={100} className="md:col-span-2 lg:col-span-1 lg:row-span-2">
              <div className="h-full group relative rounded-2xl sm:rounded-3xl overflow-hidden">
                <img 
            ...
            {/* Visual Design */}
            <FadeIn delay={150}>
              <div className="h-full group backdrop-blur-xl bg-white/5 border border-white/10 rounded-2xl sm:rounded-3xl p-6 sm:p-8 hover:bg-white/10 transition-all duration-300">
            ...
            <div className="space-y-12">
              {[
                ...
                <FadeIn key={index} delay={index * 100}>
                  <div className={`relative flex flex-col md:flex-row gap-8 ${item.align === 'left' ? 'md:flex-row-reverse' : ''}`}>
                    {/* Timeline dot */}
