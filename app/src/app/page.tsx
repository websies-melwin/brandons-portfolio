					...
					<div className="backdrop-blur-xl bg-white/5 border border-white/10 rounded-3xl p-8 sm:p-12 md:p-16 text-center">
						...
						<div className="flex items-center justify-center gap-4">
							...
							<div className="flex items-center gap-3">
								<a href="https://www.instagram.com/iamm__brandon/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/10 hover:bg-white/20 flex items-center justify-center transition-all duration-300 hover:scale-110">
				...
				<div className="max-w-6xl mx-auto">
					<div className="backdrop-blur-xl bg-white/5 border border-white/10 rounded-xl sm:rounded-2xl px-4 sm:px-8 py-5 sm:py-6 flex flex-col md:flex-row items-center justify-between gap-4">
						...
						<div className="flex items-center gap-4 sm:gap-6">
							<a href="https://www.instagram.com/iamm__brandon/" target="_blank" rel="noopener noreferrer" className="text-zinc-400 hover:text-white active:text-white transition-colors text-xs sm:text-sm">Instagram</a>
							<a href="mailto:brandon.bui04@gmail.com" className="text-zinc-400 hover:text-white active:text-white transition-colors text-xs sm:text-sm">Email</a>
